...
- Nome do projeto: API REST para Gesṭo
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: API REST robusta para gesṭo de utilizadores, autentica̤̣o JWT, valida̤̣o de dados e documenta̤̣o completa com Swagger.
- Tipo: Full-Stack
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar API REST para Gesṭo com UX simples.
