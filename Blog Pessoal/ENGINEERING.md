...
- Nome do projeto: Blog Pessoal
- Nome do repositorio: https://github.com/seuusuario/personal-blog
- Descricao: Blog responsivo com sistema de comentarios, integracao com redes sociais, SEO otimizado e painel de administracao intuitivo.
- Tipo: Full-Stack
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Blog Pessoal com UX simples.
...
- CRUD principal: Posts, comentarios
