...
- Nome do projeto: Landing Page Institucional
- Nome do repositorio: https://github.com/seuusuario/landing-page
- Descricao: Pagina institucional moderna e responsiva com animacoes suaves, formulario de contacto integrado e otimiza??o para conversoes.
- Tipo: Frontend
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Landing Page Institucional com UX simples.
...
- State management: Estado local
- UI library / design system: CSS custom + GSAP
