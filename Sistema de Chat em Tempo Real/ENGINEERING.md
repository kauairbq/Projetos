...
- Nome do projeto: Sistema de Chat em Tempo Real
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: Aplicacao de chat com salas privadas, mensagens em tempo real via WebSocket, envio de ficheiros e interface moderna.
- Tipo: Full-Stack
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Sistema de Chat em Tempo Real com UX simples.
...
- CRUD principal: Mensagens, salas
