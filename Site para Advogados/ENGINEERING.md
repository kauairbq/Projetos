...
- Nome do projeto: Site para Advogados
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: Website institucional para escritorios, com areas de atuacao, agendamento e formulario seguro.
- Tipo: Frontend
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Site para Advogados com UX simples.
