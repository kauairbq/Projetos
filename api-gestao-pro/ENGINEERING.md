...
- Nome do projeto: API Gesṭo Pro
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: API REST com JWT, RBAC, PostgreSQL, Swagger e testes automatizados.
- Tipo: Full-Stack
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar API Gesṭo Pro com UX simples.
