# Site da Banda Rock Band

## 1) Identificacao do Projeto
- Nome do projeto: Site da Banda Rock Band
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: Site institucional de banda de rock alternativo, com agenda de concertos, albuns, galeria, contacto e modo escuro.
- Tipo: Frontend
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Site da Banda Rock Band com UX simples.
...
- UI library / design system: Bootstrap
- Responsividade / A11y: Responsivo + A11y basico
