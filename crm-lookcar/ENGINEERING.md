# CRM LookCar (Vue + Express)

## 1) Identificacao do Projeto
- Nome do projeto: CRM LookCar (Vue + Express)
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: CRM para leads de stand automotivo com paineis, gest?o de clientes/negocios e importador de contactos.
- Tipo: Full-Stack
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar CRM LookCar (Vue + Express) com UX simples.
...
- UI library / design system: TailwindCSS
...
- CRUD principal: Leads, clientes, negocios
