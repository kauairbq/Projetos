...
- Nome do projeto: Dashboard Dados Reais
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: Dashboard React + TypeScript com dados reais da API p?blica CoinGecko.
- Tipo: Frontend
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Dashboard Dados Reais com UX simples.
