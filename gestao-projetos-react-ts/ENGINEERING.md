# Gest?o de Projetos (React + TS)

## 1) Identificacao do Projeto
- Nome do projeto: Gest?o de Projetos (React + TS)
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: Dashboard de projetos e tarefas com valida??o e progresso, persist?ncia local.
- Tipo: Frontend
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Gest?o de Projetos (React + TS) com UX simples.
