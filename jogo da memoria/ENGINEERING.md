...
- Nome do projeto: Jogo da Memoria
- Nome do repositorio: https://github.com/seuusuario/memory-game
- Descricao: Jogo interativo da memoria desenvolvido com JavaScript puro, niveis de dificuldade e sistema de pontuacao.
- Tipo: Frontend
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Jogo da Memoria com UX simples.
