...
- Nome do projeto: Stand Automoveis
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: Landing moderna para stand automotivo com filtros de stock, destaques e CTA.
- Tipo: Frontend
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Stand Automoveis com UX simples.
