...
- Nome do projeto: Personal Trainer (Landing)
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: Portefolio estatico com servicos, dicas, biblioteca de exercicios e calculadoras rapidas para IMC e macros.
- Tipo: Frontend
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Personal Trainer (Landing) com UX simples.
