# Catalogo de Produtos (POO + API)

## 1) Identificacao do Projeto
- Nome do projeto: Catalogo de Produtos (POO + API)
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: Sistema de gest?o de catalogo com POO, edicao inline, filtros, persist?ncia em localStorage e detalhes via Fake Store API.
- Tipo: Frontend
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar Catalogo de Produtos (POO + API) com UX simples.
...
- CRUD principal: Produtos, filtros
