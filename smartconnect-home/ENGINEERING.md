...
- Nome do projeto: SmartConnect Home
- Nome do repositorio: (sem repositorio dedicado)
- Descricao: App de automacao residencial com perfis (admin/utilizador), packs modulares, dispositivos, suporte e auditoria.
- Tipo: Full-Stack
- Status: Estavel
- Nivel alvo: Senior

## 2) Objetivo & Contexto de Negocio
- Problema que resolve: Centralizar SmartConnect Home com UX simples.
